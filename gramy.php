...
<head>
	...
	<meta name="keywords" content="taaaaaaaaaaaa" />
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
	<script src ="jquery.js"></script>
	<script src ="availableplayers.js"></script>
	<?php
...
<body>
	...
	<div id="container">
		...
		<div id="nav">
			<h2><a href="logout.php">Wyloguj się</a></h2><br />
...
<form name="scores"><textarea name="scores2" cols="60" rows="5" ></textarea>
